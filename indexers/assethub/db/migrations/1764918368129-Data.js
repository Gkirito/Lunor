module.exports = class Data1764918368129 {
    name = 'Data1764918368129'
    ...
    async up(db) {
        ...
        await db.query(`DROP INDEX "assethub"."idx_member_pool_id"`)
        await db.query(`DROP INDEX "assethub"."idx_member_account"`)
        await db.query(`DROP INDEX "assethub"."idx_event_pool_id"`)
        await db.query(`DROP INDEX "assethub"."idx_event_type"`)
        await db.query(`DROP INDEX "assethub"."idx_event_account"`)
        await db.query(`DROP INDEX "assethub"."idx_snapshot_time"`)
        await db.query(`DROP INDEX "assethub"."idx_snapshot_pool_id"`)
        await db.query(`DROP INDEX "assethub"."idx_pool_state"`)
        await db.query(`DROP INDEX "assethub"."idx_pool_staked"`)
        await db.query(`DROP INDEX "assethub"."idx_pool_created_at"`)
        await db.query(`DROP INDEX "assethub"."idx_pool_updated_at"`)
        await db.query(`ALTER TABLE "nomination_pool_member" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_member" ADD "pool_id" character varying NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_member" DROP COLUMN "account"`)
        await db.query(`ALTER TABLE "nomination_pool_member" ADD "account" text NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "extrinsic_hash"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "extrinsic_hash" text`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "event_type"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "event_type" text NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "pool_id" character varying`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "account"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "account" text`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" ADD "pool_id" character varying NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" DROP COLUMN "state"`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" ADD "state" text NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "state"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "state" text NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool" ALTER COLUMN "total_staked" DROP DEFAULT`)
        await db.query(`ALTER TABLE "nomination_pool" ALTER COLUMN "member_count" DROP DEFAULT`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "root_account"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "root_account" text NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "nominator_account"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "nominator_account" text`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "bouncer_account"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "bouncer_account" text`)
    ...
    async down(db) {
        ...
        await db.query(`CREATE INDEX "idx_member_pool_id" ON "nomination_pool_member" ("pool_id") `)
        await db.query(`CREATE INDEX "idx_member_account" ON "nomination_pool_member" ("account") `)
        await db.query(`CREATE INDEX "idx_event_pool_id" ON "nomination_pool_event" ("pool_id") `)
        await db.query(`CREATE INDEX "idx_event_type" ON "nomination_pool_event" ("event_type") `)
        await db.query(`CREATE INDEX "idx_event_account" ON "nomination_pool_event" ("account") `)
        await db.query(`CREATE INDEX "idx_snapshot_time" ON "nomination_pool_snapshot" ("snapshot_time") `)
        await db.query(`CREATE INDEX "idx_snapshot_pool_id" ON "nomination_pool_snapshot" ("pool_id") `)
        await db.query(`CREATE INDEX "idx_pool_state" ON "nomination_pool" ("state") `)
        await db.query(`CREATE INDEX "idx_pool_staked" ON "nomination_pool" ("total_staked") `)
        await db.query(`CREATE INDEX "idx_pool_created_at" ON "nomination_pool" ("created_at") `)
        await db.query(`CREATE INDEX "idx_pool_updated_at" ON "nomination_pool" ("updated_at") `)
        await db.query(`ALTER TABLE "nomination_pool_member" ADD "pool_id" integer NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_member" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_member" ADD "account" character varying(100) NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_member" DROP COLUMN "account"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "extrinsic_hash" character varying(100)`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "extrinsic_hash"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "event_type" character varying(50) NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "event_type"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "pool_id" integer`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_event" ADD "account" character varying(100)`)
        await db.query(`ALTER TABLE "nomination_pool_event" DROP COLUMN "account"`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" ADD "pool_id" integer NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" DROP COLUMN "pool_id"`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" ADD "state" character varying(20) NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool_snapshot" DROP COLUMN "state"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "state" character varying(20) NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "state"`)
        await db.query(`ALTER TABLE "nomination_pool" ALTER COLUMN "total_staked" SET DEFAULT '0'`)
        await db.query(`ALTER TABLE "nomination_pool" ALTER COLUMN "member_count" SET DEFAULT '0'`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "root_account" character varying(100) NOT NULL`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "root_account"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "nominator_account" character varying(100)`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "nominator_account"`)
        await db.query(`ALTER TABLE "nomination_pool" ADD "bouncer_account" character varying(100)`)
        await db.query(`ALTER TABLE "nomination_pool" DROP COLUMN "bouncer_account"`)
